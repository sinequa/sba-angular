...
- **Facet** library:
  - Facet card: Various additions to the sq-facet-card API (See [https://sinequa.github.io/sba-angular/modules/components/facet.html](https://sinequa.github.io/sba-angular/modules/components/facet.html)). These new features are used in the new "Mini-Preview" of Vanilla Search and should be used more generally for displaying complex components with multiple views, actions and options.
...
- New multi-level pie chart component to display tree-typed metadata. See [https://sinequa.github.io/sba-angular/modules/analytics/fusioncharts.html](https://sinequa.github.io/sba-angular/modules/analytics/fusioncharts.html)
