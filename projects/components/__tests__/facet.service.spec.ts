...
import {
  AGGREGATION_INTEGER,
  AGGREGATION_NULL,
  AGGREGATION_TREEPATH,
} from "./mocks/aggregations";

describe("FacetService", () => {
  const aggregation = {
    geo: AGGREGATION_GEO as Aggregation,
    treepath: AGGREGATION_TREEPATH as unknown as Aggregation,
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [
        ...
        {
          provide: UserSettingsWebService,
          useFactory: UserSettingsWebServiceFactory,
        },
  ...
  describe("facets filters", () => {
    ...
    describe("addFilterSearch", () => {
      it("should trigger an event", () => {
        ...
        // When
        service.addFilterSearch(aggregation["geo"], items);
        ...
        expect(service.events.next).toHaveBeenCalledWith({
  ...
  describe("suggestionsToTreeAggregationNodes", () => {
    it("should return a list of suggestions", () => {
      ...
      const nodes: TreeAggregationNode[] =
        service.suggestionsToTreeAggregationNodes(suggests, term, agg);
