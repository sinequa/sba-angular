	...
	describe("facets filters", () => {
		...
		describe("addFilterSearch", () => {
			...
			it("should trigger an event", () => {
				...
				// Then
				expect(service.addFilter).toHaveBeenCalledWith(aggregation["geo"], items, {}, searchService.query);
				expect(service.events.next).toHaveBeenCalledWith({type: FacetEventType.AddFilter, facet: undefined, query: searchService.query});
			})
