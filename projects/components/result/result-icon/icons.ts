...
export const defaultFormatIcons: Record<string, IconFormat> = {
    ...
    "htm": { icon: "fas fa-globe-europe", color: '#ffffff' },
    "html": { icon: "fas fa-globe-europe", color: '#ffffff' },
    "xhtm": { icon: "fas fa-globe-europe", color: '#ffffff' },
    "xhtml": { icon: "fas fa-globe-europe", color: '#ffffff' },
    "mht": { icon: "fas fa-globe-europe", color: '#ffffff' },
